...
```json
{
  ...
  "stamp_image_url": "[https://firebasestorage.googleapis.com/.../stamps/meatball.png](https://firebasestorage.googleapis.com/.../stamps/meatball.png)",
  "rating": 5,
...
在專案根目錄手動建立一個 `.env.local` 檔案，並填入你的 Firebase 配置（此檔案已被加入 `.gitignore`，切勿推上 GitHub）：
